    ...
    unsafe {
        ...
        if !sigmask.is_null() {
            crate::signal_impl::sigprocmask(
                ...
                sigmask as *const crate::signal_impl::Sigset,
                &mut saved_mask as *mut u32 as *mut crate::signal_impl::Sigset,
            );
        }
        ...
        if !sigmask.is_null() {
            crate::signal_impl::sigprocmask(
                crate::signal_impl::SIG_SETMASK,
                &saved_mask as *const u32 as *const crate::signal_impl::Sigset,
                core::ptr::null_mut(),
            );
        }
